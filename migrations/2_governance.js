...
const rinkeby = {
	locking: "0xAc8369a64e35d4778e535Ac78398f2Bb09bCa7f0",
  canceler: "0x3f46680099cF623163C96747a8ADdB85a1dA1Cd1"
}
const goerli = {
	locking: "0x6D5E228C25730502aF5ACffa2eB34956c33ad7C2",
  canceler: "0x19d2a55F2Bd362a9e09F674B722782329F63F3fB" //
}
const dev = {
	locking: "0x55eB2809896aB7414706AaCDde63e3BBb26e0BC6",
  canceler: "0x3f46680099cF623163C96747a8ADdB85a1dA1Cd1"
}
const def = {
	locking: "0x0000000000000000000000000000000000000000",
  canceler: "0x3f46680099cF623163C96747a8ADdB85a1dA1Cd1"
}
...
module.exports = async function (deployer, network, accounts) {
  ...
  const {canceler, locking} = await getSettings(network);
  ...
  //deploy governon
  const governor = await deployProxy(RariGovernor, [locking, timeLock.address], { deployer, initializer: '__RariGovernor_init' })
  console.log(`deployed governor at ${governor.address} for ${locking}`)
