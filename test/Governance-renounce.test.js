...
contract("Governance-renounce", accounts => {
  let token;
  let governorTest;
  let timelock;
  let proxyAdmin;
  ...
  let securityCouncil;
    ...
    await timelock.grantRole(PROPOSER_ROLE, securityCouncil)
    await timelock.grantRole(EXECUTOR_ROLE, securityCouncil)
